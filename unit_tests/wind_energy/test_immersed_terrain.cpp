...
// Partial terrain fraction, mask classification and surface height
...
TEST_F(ImmersedTerrainTest, fraction_mask_and_height)
{
    ...
    // Surface height on top of the plateau
    EXPECT_NEAR(
