...
.. input_param:: incflo.physics
   ...
   **type:** List of strings
   ...
   For immersed boundary forcing method TerrainDrag must be specified and the folder should include a terrain file (default name: `terrain.amrwind`, user control is `TerrainDrag.terrain_file`) file. For partial terrain overlap using volume fractions or distance function blanking, PartialTerrainDrag should be specified instead.
